    ...
    <div className="space-y-5 w-full max-w-full">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4 transition-colors">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl border border-slate-200 dark:border-slate-700">
            <button
              ...
              className="w-8 h-8 rounded-xl bg-white dark:bg-slate-700 hover:bg-slate-50 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 flex items-center justify-center shadow-xs transition-all hover:-translate-y-0.5 active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold shadow-xs transition-all hover:-translate-y-0.5 active:scale-95 cursor-pointer"
          >
            Today
          </button>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-xs font-bold text-emerald-900 dark:text-emerald-200">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 text-xs bg-slate-50 dark:bg-slate-900 px-4 py-2.5 rounded-2xl border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 transition-colors">
        <div className="flex flex-wrap items-center gap-4">
          <span className="font-bold text-slate-700 dark:text-slate-200">Cell Key:</span>
          <div className="flex items-center gap-1.5">
            <span className="w-5 h-5 rounded-md bg-green-50 dark:bg-emerald-950/80 border border-green-400 dark:border-emerald-600 text-green-700 dark:text-emerald-300 font-bold text-xs flex items-center justify-center shadow-xs">
              +
            </span>
            <span>Present</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-5 h-5 rounded-md bg-red-50 dark:bg-rose-950/80 border border-red-400 dark:border-rose-600 text-red-700 dark:text-rose-300 font-bold text-xs flex items-center justify-center shadow-xs">
              -
            </span>
            <span>Absent</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-5 h-5 rounded-md bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 font-medium text-xs flex items-center justify-center">
              ?
            </span>
            <span>No lesson recorded</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-5 h-5 rounded-md bg-slate-200/70 dark:bg-slate-800 text-slate-400 font-mono text-xs flex items-center justify-center">
              /
            </span>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden max-w-full transition-colors">
